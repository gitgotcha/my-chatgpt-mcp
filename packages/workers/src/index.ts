...
import { createProductionDriveAdapter, type DestinationAdapter } from "./drive-adapter.js";
...
export function createWorker(
  ...
  const sync = createSyncHandler(env, jobRepository, adapter ?? createProductionDriveAdapter(env));
  return {
