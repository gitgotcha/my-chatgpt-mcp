...
const entries = [];
for (const relative of files) entries.push({ path: relative, sha256: hash(await readFile(join(root, relative))) });
...
const output = join(root, "dist", "device-runtime-manifest.json");
